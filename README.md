...
[![Github release](https://img.shields.io/github/release/ammardab3an/cf-tool.svg)](https://github.com/ammardab3an/cf-tool/releases)
[![platform](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-blue.svg)](https://github.com/ammardab3an/cf-tool/releases)
[![Build Status](https://travis-ci.org/ammardab3an/cf-tool.svg?branch=master)](https://travis-ci.org/ammardab3an/cf-tool)
[![Go Report Card](https://goreportcard.com/badge/github.com/ammardab3an/cf-tool)](https://goreportcard.com/report/github.com/ammardab3an/cf-tool)
[![Go Version](https://img.shields.io/badge/go-%3E%3D1.12-green.svg)](https://github.com/golang)
[![license](https://img.shields.io/badge/license-MIT-%23373737.svg)](https://raw.githubusercontent.com/ammardab3an/cf-tool/master/LICENSE)
...
You can download the pre-compiled binary file in [here](https://github.com/ammardab3an/cf-tool/releases).
...
Examples:
  ...
  cf pull              Pull the latest codes of current problem into current
                       path.
  cf clone ammardab3an      Clone all codes of ammardab3an.
...
Script in template:
  ...
  $%path%$   Path to source file (Excluding $%full%$, e.g. "/home/ammardab3an/")
 ...
 * You can download the binary file in here https://github.com/ammardab3an/cf-tool (Windows, macOS, Linux)
 * Author: $%U%$
 * Time: $%Y%$-$%M%$-$%D%$ $%h%$:$%m%$:$%s%$
**/
