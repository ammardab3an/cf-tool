...
你可以从[这里](https://github.com/ammardab3an/cf-tool/releases)直接下载一个可执行文件。
...
例子:
  ...
  cf clone ammardab3an      拉取 ammardab3an 的所有提交代码。
...
模板内的脚本:
  ...
  $%path%$   代码的路径 (不包括 $%full%$， 比如 "/home/ammardab3an/")
